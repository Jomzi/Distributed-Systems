...
public class CarBookingServiceImpl extends UnicastRemoteObject implements CarBookingService {
    ...
    public CarBookingServiceImpl(MongoDatabase db) throws RemoteException {
        super();
