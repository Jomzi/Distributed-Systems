...
import com.assignment.carbooking.CarBookingService;
import com.assignment.carbooking.CarBookingServiceImpl;
...
public class ServerConnection {
    ...
    public void Start(MongoDatabase db) throws Exception {
        ...
        CarBookingService s = new CarBookingServiceImpl(db);
